...
path: "/blog/k8s-on-pi"
date: "2019-01-06"
title: 'A "production-ish" Kubernetes cluster on Raspberry Pi'
summary: 'This guide shows how to build a "production-ish" Kubernetes (k8s) cluster on Raspberry Pi hardware'
tags: ["blog"]
---
...
GitHub project: https://github.com/ljfranklin/k8s-pi

X-Posted to [Medium](https://medium.com/@lylejfranklin/a-production-ish-kubernetes-cluster-on-raspberry-pi-d451dc6e1b17)
